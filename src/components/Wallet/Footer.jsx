...
const Footer = () => {
  return (
    <div className="bg-[#020710] w-full mx-auto pt-10 rounded-xl px-6 font-inter">
      <div className="max-w-5xl mx-auto grid grid-cols-1 sm:grid-cols-2 md:grid-cols-5 gap-6 text-white">
        {/* Features */}
        <div>
      ...
      <div className="py-10 px-6 text-white">
        ...
        {/* Search Bar */}
        <div className="flex max-w-7xl gap-3 w-full mt-10 justify-center items-center text-black">
        <div className="flex items-center max-w-2xl w-full border border-gray-300 overflow-hidden">
          <input
            type="text"
            placeholder="Search for product overviews, FAQs, and more..."
            className="flex-grow px-4 py-2 outline-none bg-white text-[#757575] placeholder:text-[#757575]"
          />
        ...
        <div>
        <select className="px-3 py-3 border-l border-gray-300 bg-[#C4C4C4] outline-none">
        ...
        {/* Legal Links */}
        <div className="max-w-5xl mx-auto flex flex-wrap justify-center gap-4 text-xs text-white mt-6">
          <span>Zoho Home</span>
