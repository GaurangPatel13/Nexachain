import connectimg from "/assets/SmartContract/connectimg.jpeg";
        ...
        <div className="flex items-center justify-center lg:justify-end h-full lg:px-24">
          <div className="bg-white p-6 md:p-6 rounded-lg shadow-lg max-w-xl w-72 sm:w-lg text-center sm:text-start">
            ...
            <div className="mt-4 flex gap-5 ">
              <button className="bg-[#FC268A] text-[#F0F6FC] text-sm px-4 py-2 shadow-md">
              Connect On Whatsapp
              </button>
              <button className="bg-white text-[#FC268A] border-1 border-[#FC268A] text-sm px-4 py-2 shadow-md">
              Connect On Telegram
              </button>
            </div>
          </div>
