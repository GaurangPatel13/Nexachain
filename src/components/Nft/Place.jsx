      ...
      <div className='md:px-10 px-5 py-14'>
          <div className='relative'>
              ...
              <div className='text-center flex flex-col w-full items-center lg:space-y-20 rounded-xl space-y-7 p-2 bg-blue-500 md:bg-transparent md:absolute md:top-1/2 md:left-1/2 md:-translate-x-1/2 md:-translate-y-1/2'>
                  <h1 className='xl:text-6xl 2xl:text-7xl lg:text-5xl sm:text-3xl font-chillax relative z-20 md:z-0 text-white uppercase'>Join Us to make The world a<br />better place</h1>
                  <p className='font-poppins lg:max-w-2xl md:max-w-lg 2xl:max-w-3xl 2xl:text-xl sm:text-sm relative z-20 lg:z-0 text-xs text-white xl:text-xl'>Smaller currencies may often appear to have a lower carbon footprint, but that may simply be because there are fewer transactions.</p>
                  <button className='font-poppins relative z-20 md:z-0 cursor-pointer text-xs bg-white font-semibold text-[#4A3AFF] px-4 py-2 rounded-lg sm:text-sm 2xl:text-xl'>Contact Us</button>
              </div>
