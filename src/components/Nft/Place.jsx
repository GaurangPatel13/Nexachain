      ...
      <div className='md:px-10 px-5 py-14'>
          <div className='relative'>
              ...
              <div className='text-center flex flex-col w-full items-center lg:space-y-20 rounded-xl space-y-7 p-2 bg-blue-500 md:bg-transparent md:absolute md:top-1/2 md:left-1/2 md:-translate-x-1/2 md:-translate-y-1/2'>
                  ...
                  <p className='font-poppins lg:max-w-2xl md:max-w-lg 2xl:max-w-3xl 2xl:text-xl sm:text-sm relative z-20 lg:z-0 text-xs text-white'>Smaller currencies may often appear to have a lower carbon footprint, but that may simply be because there are fewer transactions.</p>
