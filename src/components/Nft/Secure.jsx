          ...
          <div className='relative flex flex-col gap-4 md:block'>
              <div className='flex items-center gap-14 sm:absolute sm:-top-12 sm:left-10 xl:top-0 xl:left-0 md:-top-12 md:left-14 lg:left-20'>
                  ...
                  <div className='flex flex-col items-center space-y-2'>
                      <button className='text-[#2B2727] bg-[#E7EEFA] px-3 rounded-lg py-1.5 font-poppins'>TRANSFORM</button>
                      <div className='text-center lg:text-6xl md:text-5xl text-4xl font-chillax'>
              ...
              <img src={bg} alt="" />
              <div className='md:w-3/11 font-poppins md:text-xs text-[#162639] relative z-20 md:absolute xl:bottom-10 xl:right-6 lg:bottom-5 lg:right-5 md:bottom-2 md:right-1 lg:text-sm'>
