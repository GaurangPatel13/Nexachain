...
const Mint = () => {
  return (
    <section className="relative overflow-hidden px-4 py-8 md:py-16 bg-white text-center">
      ...
      <div className="mb-4 relative">
        <span className="bg-[#8743FF] text-white px-4 py-2 font-abeezee rounded-lg text-base font-medium">
          Investment
              ...
              <img src={purpleOrb} className="w-7 absolute bottom-0 md:left-1/4" alt="" />
      </div>
      ...
      <p className="mt-4 text-gray-600 max-w-3xl font-poppins mx-auto text-sm md:text-base relative z-20">
      ...
      {/* Stats */}
      <div className="mt-12 flex flex-col md:flex-row items-center gap-6 justify-between font-chillax max-w-5xl mx-auto px-4">
        <div className="bg-[#FFF2E2] text-left md:p-10 p-5 rounded-xl md:w-1/2 w-full shadow-md flex flex-col gap-4">
          <div className="text-2xl md:text-4xl text-[#1E344F]">$105.018 USD</div>
        ...
        <div className="flex flex-col items-center gap-5 md:w-1/2 w-full">
          <div className="bg-white text-left md:p-10 p-5 w-full rounded-xl shadow-md flex flex-col gap-4">
            <div className="text-2xl md:text-4xl text-[#1E344F]">$1,894,803,003 USD</div>
            <div className="flex items-center gap-3">
          ...
          <div className="bg-[#8743FF] text-white w-full text-left md:p-10 p-5 rounded-xl shadow-md flex flex-col gap-4">
            <div className="text-2xl md:text-4xl">$555,869,950 USD</div>
            <div className="flex items-center gap-3">
