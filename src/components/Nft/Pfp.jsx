    ...
    <section className="w-full relative px-5 xl:px-20 py-8 lg:pb-26 bg-white lg:mt-72 lg:flex lg:items-center lg:justify-end">
      ...
      <div className="relative lg:w-4/5 flex flex-col gap-5 lg:block mt-10 lg:mt-0">
        ...
        <div className="lg:absolute top-30 -left-1/5">
          <span className="inline-block bg-[#EFE4FC] text-[#2B2727] font-poppins font-bold px-3 py-1 rounded-lg text-base 2xl:text-lg mb-4">
            COIN
          </span>
          <h1 className="text-[#1E344F] relative z-20 lg:text-5xl 2xl:text-7xl xl:text-6xl md:text-6xl sm:text-5xl text-4xl font-chillax before:w-1.5 md:before:h-32 2xl:before:h-38 before:h-20 sm:before:h-26 lg:before:h-26 xl:before:h-32 before:absolute before:top-1/2 before:-translate-y-1/2 leading-snug before:-left-3 before:rounded-full before:bg-[#6052FF] before:inline-block">
            PFP BIT
            <br />
            <span className="text-[#6052FF]">Marketplace</span>
            <img
              src={pimg}
              className="w-20 2xl:w-30 absolute top-1/2 -translate-y-1/2 right-1/2 translate-x-1/2 sm:left-1/5"
              alt=""
            />
            <img src={pball} className="w-10 2xl:w-16 absolute right-0 top-0" alt="" />
          </h1>
        </div>
        ...
        <div className="lg:absolute top-0 right-20 lg:right-1 xl:right-20 2xl:text-xl 2xl:right-40">
          <img src={bar} className="w-1/2 mb-6 lg:mb-4 xl:mb-6" alt="" />
          <p className="text-[#342E2E] font-poppins mb-6 max-w-sm 2xl:max-w-md lg:mb-4 xl:mb-6">
